package view.avatar
{
    ...
    public class AvatarArea extends Sprite
    {
        ...
        {
			// 大头像框
            this.bigBox = this.setBoxs(Param.pSize[2], Param.pSize[3], 0, 0);
			addChild(this.bigBox);
			// 中头像框
            if(Param.pSize[4]>0){
				this.midBox = this.setBoxs(Param.pSize[4], Param.pSize[5], Param.pSize[2]+10, 0);
				addChild(this.midBox);
			}
			// 小头像框
			if(Param.pSize[6]>0){
				this.smallBox = this.setBoxs(Param.pSize[6], Param.pSize[7], Param.pSize[2]+Param.pSize[4]+20, 0);
        ...
        {
            var _txtFormat = new TextFormat("宋体", 12, 0xDDDDDD);
				_txtFormat.leading = 4;
			var _txtFormat2 = _txtFormat3 = new TextFormat("宋体", 12, 0xDDDDDD);
				_txtFormat2.align = TextFormatAlign.LEFT;

			// 大头像文本框
            this.bigTxt	= this.setText(Param.pSize[2],0,Param.pSize[3]+6,Param.pSize[2]+"*"+Param.pSize[3]+"像素",_txtFormat2);
			addChild(this.bigTxt);
			// 中头像文本框
			if(Param.pSize[4]>0){
				this.midTxt	= this.setText(100,Param.pSize[2]+10,Param.pSize[5]+6, Param.pSize[4]+"*"+Param.pSize[5]+"像素", _txtFormat3);
				 addChild(this.midTxt);
			}
			// 小头像文本框
			if(Param.pSize[6]>0){
				this.smalltxt = this.setText(100,Param.pSize[2]+Param.pSize[4]+20,Param.pSize[7]+6, Param.pSize[6]+"*"+Param.pSize[7]+"像素", _txtFormat3);
